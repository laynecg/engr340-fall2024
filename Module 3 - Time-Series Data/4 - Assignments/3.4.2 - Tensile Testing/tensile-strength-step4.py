...
def calculate_stress(force, sample_diameter):
    ...
    ### your code here ###
    CSArea = math.pi * (sample_diameter/2) ** 2
    # calculate stress (MPa) from load (kN) and cross-sectional area
    ### your code here ###
    Stress = force / CSArea * 1000
...
def calculate_percent_offset(slope, strain, stress):
    ...
    # _,_,z defines the return called out; lets you define a variable from a previous function
    # Harrison showed me this 'technique'
    _,_,intercept = calculate_elastic_modulus(stress,strain)
