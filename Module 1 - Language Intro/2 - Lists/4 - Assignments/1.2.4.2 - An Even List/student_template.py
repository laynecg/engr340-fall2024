...
#Finding the middle variables in the list
middle_index1 = list_length/2
middle_index2 = list_length/2 - 1

#Making sure the variables are integers
m1 = even_list[int(middle_index1)]
m2 = even_list[int(middle_index2)]

# this is the final result. Modify this line, and the empty lines above, to solve the assignment
middle_average = (m1 + m2)/2
